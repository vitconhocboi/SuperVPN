...
import com.simple.libads.databinding.GntSmallCtaBottom0Binding


class AdmobNativeAdSmallCtaBottom(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntSmallCtaBottom0Binding.inflate(LayoutInflater.from(context), this, true)
