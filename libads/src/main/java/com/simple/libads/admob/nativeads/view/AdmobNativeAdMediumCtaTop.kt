...
import com.simple.libads.databinding.GntMediumCtaTop5Binding


class AdmobNativeAdMediumCtaTop(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntMediumCtaTop5Binding.inflate(LayoutInflater.from(context), this, true)
