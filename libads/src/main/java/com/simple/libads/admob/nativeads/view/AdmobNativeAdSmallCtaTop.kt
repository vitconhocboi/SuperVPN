...
import com.simple.libads.databinding.GntSmallCtaTop2Binding


class AdmobNativeAdSmallCtaTop(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntSmallCtaTop2Binding.inflate(LayoutInflater.from(context), this, true)
