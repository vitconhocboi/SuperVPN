...
import com.simple.libads.databinding.GntSmallCtaRight1Binding


class AdmobNativeAdSmallCtaRight(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntSmallCtaRight1Binding.inflate(LayoutInflater.from(context), this, true)
