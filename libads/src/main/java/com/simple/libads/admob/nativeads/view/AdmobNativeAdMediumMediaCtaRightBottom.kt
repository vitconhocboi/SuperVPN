...
import com.simple.libads.databinding.GntMediumNoIconCtaRightBottom8Binding


class AdmobNativeAdMediumMediaCtaRightBottom(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntMediumNoIconCtaRightBottom8Binding.inflate(LayoutInflater.from(context), this, true)
