...
import com.simple.libads.databinding.GntMediumCtaBottom3Binding


class AdmobNativeAdMediumCtaBottom(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntMediumCtaBottom3Binding.inflate(LayoutInflater.from(context), this, true)
