...
import com.simple.libads.databinding.GntMediumCtaRightTop6Binding


class AdmobNativeAdMediumCtaTopRight(context: Context, attrs: AttributeSet?) : BaseNativeAdView(context, attrs) {
    private val binding = GntMediumCtaRightTop6Binding.inflate(LayoutInflater.from(context), this, true)
