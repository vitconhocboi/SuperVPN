package com.common.baseui.view.indicator.indicator;
...
import com.common.baseui.view.indicator.animation.AnimationValue;
import com.common.baseui.view.indicator.animation.ColorAnimation;
import com.common.baseui.view.indicator.animation.IndicatorAnimation;
import com.common.baseui.view.indicator.animation.ScaleAnimation;
import com.common.baseui.view.indicator.animation.SlideAnimation;
import com.common.baseui.view.indicator.painter.CirclePainter;
        ...
        if (attrs != null) {
            ...
            try {
                ...
                indicatorSelectedColor = typedArray.getColor(
                        R.styleable.CircleIndicator_indicatorSelectedColor, ContextCompat.getColor(context, R.color.primary_color));
