...
import com.common.baseui.view.indicator.painter.RectPainter;
        ...
        if (attrs != null) {
            ...
            try {
                ...
                indicatorSelectedColor = typedArray.getColor(
                        R.styleable.RectIndicator_indicatorSelectedColor, ContextCompat.getColor(context, R.color.primary_color));
