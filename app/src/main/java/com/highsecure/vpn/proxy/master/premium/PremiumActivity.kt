...
import com.highsecure.vpn.proxy.master.databinding.ActivityPremiumBinding
...
class PremiumActivity : ProductActivity<ActivityPremiumBinding>() {
    ...
    override fun initView() {
        supportFragmentManager.beginTransaction()
            .replace(com.highsecure.vpn.proxy.master.R.id.fragment_container_pre, PremiumFragment())
            .commit()
    }
}