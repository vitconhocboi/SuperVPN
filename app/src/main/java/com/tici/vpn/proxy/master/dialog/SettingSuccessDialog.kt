...
import com.tici.vpn.proxy.master.databinding.PopupSettingSuccessBinding

class SettingSuccessDialog (
    val titleId: Int,
    val contentId: Int = com.tici.vpn.proxy.master.R.string.reconnect_to_take_effect
) : DialogFragment() {
    ...
    override fun onStart() {
        ...
        dialog?.window?.apply {
            ...
            val marginHorizontal = resources.getDimensionPixelSize(com.tici.vpn.proxy.master.R.dimen.margin_medium) // e.g., 32dp
