...
import com.tici.vpn.proxy.master.databinding.CoreDotIndicatorBinding

class DotIndicator @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : LinearLayoutCompat(context, attrs) {
    private val _viewBinding =
        CoreDotIndicatorBinding.inflate(LayoutInflater.from(context), this, true)
